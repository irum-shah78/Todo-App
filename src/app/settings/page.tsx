    ...
    <>
      ...
      <Header />
        ...
        <div className="flex justify-end mb-4">
          <p className="font-footerText text-customFooter text-4xl sm:text-5xl lg:text-6xl">
            settings<span className="text-customOrange text-4xl sm:text-5xl lg:text-6xl">.</span>
          </p>
        </div>
      </div>
    </>
