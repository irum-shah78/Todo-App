...
import { useProfileSettings } from './useSettings';
  ...
  return (
    <div className="min-h-screen flex flex-col font-paragraph bg-customBlack dotted-background overflow-hidden">
      ...
      <div className="flex justify-end mb-4">
        <p className="font-footerText text-customFooter text-7xl lg:text-8xl md:text-5xl">settings<span className="text-customOrange">.</span></p>
      </div>
      <Toaster />
    </div>
  );
