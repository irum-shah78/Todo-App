...
export const POST = async (req: any) => {
  ...
  const mailOptions = {
    ...
    html: `<p>You requested a password change</p><p>Click <a href="${resetUrl}">here</a> to reset your password</p>`,
  };
  ...
  return NextResponse.json({ message: "Password change link sent to your email." }, { status: 200 });
};
